...
const SlideBedrockEscolha = () => {
  const steps = [
    {
      icon: Search, title: "Escolha", description: "Selecione o modelo ideal para seu caso de uso",
      color: "bg-nuage-cyan", glowColor: "shadow-nuage-cyan/40", items: ["Claude", "Llama", "Mistral", "+200 modelos"],
    },
    {
      icon: Settings, title: "Customize", description: "Ajuste com seus dados e parâmetros específicos",
      color: "bg-nuage-gold", glowColor: "shadow-nuage-gold/40", items: ["Fine-tuning", "RAG", "Prompts"],
    },
    {
      icon: Plug, title: "Integre", description: "Conecte às suas aplicações via APIs",
      color: "bg-primary", glowColor: "shadow-primary/40", items: ["REST API", "SDKs", "Agents"],
    },
  ];
      ...
      <div className="slide-content relative z-10">
        <div className="text-center mb-10">
          <h2 className="text-4xl md:text-5xl font-black tracking-tight mb-4 opacity-0 animate-fade-in-up">
            Escolha, Customize, <span className="text-gradient-magenta">Integre</span>
          </h2>
        </div>
