...
const SlideQuickSuiteProduct = () => {
  const capabilities = [
    { icon: Eye, name: "QuickSight", description: "Dashboards interativos com IA generativa para perguntas em linguagem natural", color: "text-primary", bgColor: "bg-primary/15" },
    { icon: Workflow, name: "Flows", description: "Criação de workflows automatizados sem necessidade de código", color: "text-nuage-cyan", bgColor: "bg-nuage-cyan/15" },
    { icon: Bot, name: "Automate", description: "Automação inteligente de tarefas repetitivas com agentes de IA", color: "text-nuage-gold", bgColor: "bg-nuage-gold/15" },
    { icon: Search, name: "Index", description: "Busca semântica e indexação inteligente em dados empresariais", color: "text-primary", bgColor: "bg-primary/15" },
    { icon: FlaskConical, name: "Research", description: "Pesquisa e geração de insights automatizados a partir dos seus dados", color: "text-nuage-cyan", bgColor: "bg-nuage-cyan/15" },
  ];
      ...
      <div className="slide-content relative z-10">
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-4 mb-4 opacity-0 animate-fade-in">
            <img src={quickSuiteIcon} alt="Quick Suite" className="w-12 h-12 rounded-xl" />
