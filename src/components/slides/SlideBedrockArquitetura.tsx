...
const SlideBedrockArquitetura = () => {
  ...
  return (
    <div className="slide network-bg overflow-hidden">
      ...
      <div className="slide-content relative z-10 flex flex-col justify-center h-full" style={{ transform: 'scale(0.92)', transformOrigin: 'center center', maxWidth: '1200px', width: '100%', margin: '0 auto' }}>
