...
const SlideModelosFundacionais = () => {
  const features = [
    { icon: Database, title: "Pré-treinados", description: "Em vastos montantes de dados não estruturados", color: "from-primary to-primary/60" },
    { icon: Layers, title: "Parâmetros Complexos", description: "Grande número de parâmetros capazes de aprender conceitos complexos", color: "from-nuage-cyan to-nuage-cyan/60" },
    { icon: Settings, title: "Versatilidade", description: "Podem ser aplicados em uma ampla variedade de contextos", color: "from-nuage-gold to-nuage-gold/60" },
    { icon: Target, title: "Customizáveis", description: "Podem ser customizados usando seus dados para tarefas de domínios específicos", color: "from-primary to-nuage-cyan" },
  ];
